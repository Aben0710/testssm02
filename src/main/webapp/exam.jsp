...
<body>
	<div id="div1">
		<div id="div2">
			学史明理 学史增信 学史崇德 学史力行 <input type="hidden" id="set-time" value="10" /><!-- 这里设置计时的时间 -->
			<div id="countdown">
				...
				<c:forEach items="${subjects}" var="subject">
					...
					<tr>
						<td><input type="radio"
							...
							id="subjectOptionA-${subject.subjectId}" value="A">A.${subject.subjectOptionA}</td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
						<td><input type="radio"
							name="subjectOption-${subject.subjectId}"
							id="subjectOptionB-${subject.subjectId}" value="B">B.${subject.subjectOptionB}</td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
						<td><input type="radio"
							name="subjectOption-${subject.subjectId}"
							id="subjectOptionC-${subject.subjectId}" value="C">C.${subject.subjectOptionC}</td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
						<td><input type="radio"
							name="subjectOption-${subject.subjectId}"
							id="subjectOptionD-${subject.subjectId}" value="D">D.${subject.subjectOptionD}</td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					</tr>
					<hr />
				</c:forEach>
