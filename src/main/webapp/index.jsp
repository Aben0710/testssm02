		...
		<div class="container">
			<div class="row">
				<div class="col-sm-12 col-md-12 col-lg-12">
					...
					<button id="btn1" class="btn btn-success"><a href="login.jsp">登录</a></button>
					&nbsp;&nbsp;
					<button id="btn2" class="btn btn-warning"><a href="register.jsp">注册</a></button>
					<br>
				</div>

				<div class="row">
					<div class="col-lg-6 col-lg-offset-3">
						<p class="copyright">Copyright © 2021 zeng peng</p>
					</div>
				</div>
			</div>
		</div>
